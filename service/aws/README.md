...
1. Ensure you create a user with the following cloud formation with the policy in: adop-puppet-plat-extn.policy
...
For information on how to access the Puppet server refer to the README.md file in the root of this repo.
